        ...
        <div className="project-layout">
          <div>
            ...
            <p>
              ...
              kinematics and joint control. The system includes a camera sensor
              that streams live visual data to ROS 2 topics, enabling real-time
              visualization and inspection in RViz. The project demonstrates the
              complete simulation pipeline, from robot description and sensor
              integration to motion execution and visualization.
            </p>
          </div>
...

  {
    ...
    content: (
      <div className="slide-project">
        ...
        <br></br>
        <p className="project-summary">
          A lightweight, browser-based teleoperation interface for remotely controlling
        a ROS 2–powered robot and monitoring live camera feedback over a secure web
        connection.
        </p>
        <br></br>
        <div className="project-scroll-area">
        <div className="project-layout">
          <div>
            <h3>Overview</h3>
            <p>
             TeleopX enables remote manual control of a robot from a web browser by
          bridging ROS 2 communication with modern web technologies. The system
          exposes robot control and sensor data through a secure HTTPS endpoint
          using a Cloudflare Tunnel, allowing external access without directly
          exposing the robot’s local network.
            </p>
          </div>
          <div className="project-meta">
            <div>
            ...
            <div>
              <h3>Links</h3>
              <a href="https://github.com/GuruManoharGuptaBaratam/TeleOpX-Controller" target="_blank" rel="noreferrer">
                View on GitHub
              </a>
              <h2></h2>
              <a href="https://teleop-x-controller.vercel.app/" target="_blank" rel="noreferrer">
                Hosted Link
              </a>
  ...
  <div className="project-scroll-area">
    <div className="project-layout">
      <div>
        <h3>Overview</h3>
        <p>
          This project focuses on building and understanding a complete autonomous
          navigation pipeline using ROS 2 Nav2. The robot is capable of localizing
          itself within a known map, planning global paths to user-defined goals,
          avoiding dynamic obstacles, and executing recovery behaviors when
          navigation fails.
        </p>

        <p>
          Emphasis was placed on configuration level understanding how costmaps,
          planners, controllers, and localization parameters influence real
          navigation behavior in simulation.
        </p>
      </div>
...
<div className="slide-project">
  ...
  <br></br>
  <p className="project-summary">
   A backend service built to simplify how developers manage, stream, and organize music data, providing clean APIs for search, playback metadata, and real-time client synchronization while remaining scalable and reliable.
  </p>
  ...
  <div className="project-scroll-area">
    <div className="project-layout">
      <div>
        <h3>Overview</h3>
        <p>
          Harmonixor API is a backend audio-processing engine platform that converts a user
          query or media identifier into a clean, stream-ready audio source.
          it mirrors real-world
          software infrastructure patterns such as middleware services,
      ...
      <div className="project-meta">
        ...
        <div>
          <h3>Links</h3>
          <a href="https://github.com/GuruManoharGuptaBaratam/Harmonixor-API" target="_blank" rel="noreferrer">
            View on GitHub
          </a>
          <h2></h2>
          <a href="https://harmonixor-api.vercel.app/" target="_blank" rel="noreferrer">Hosted Link</a>
        </div>
      </div>
    </div>
  ...
  <div className="contact-info">
    <h2>Contact</h2>
    <p>
      I am actively seeking internships, research opportunities, and early-career roles
      in robotics software, autonomous systems, and simulation-driven development. I am
      particularly interested in teams working on real-world robotic deployment and
  ...
  return (
    <div className="app-root">
      ...
      <Navigation
        ...
        disableNext={currentIndex === totalSlides - 1}
      />
    </div>
  );
}
